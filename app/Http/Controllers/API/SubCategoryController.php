...
{
    public function getsubcatg($id){
        return DB::select("SELECT id,`sub_image`, `category_id`, `name`, `description` FROM `jv_service_subcategories` WHERE `category_id`='$id' and status=1");
    }
