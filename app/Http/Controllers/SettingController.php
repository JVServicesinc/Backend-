...
class SettingController extends Controller
{
    ...
    {
        $setting_data = Setting::where('type','page_about')->where('key','page_about')->first();
        $pageTitle = "About Page";
        $assets = ['textarea'];

        return view('setting.about_page_form',compact('setting_data', 'pageTitle', 'assets'));
    }

    public function savePageAbout(Request $request)
    {
        $setting_data = [
                        'type'   => 'page_about',
                        'key'   =>  'page_about',
        ...
        return redirect()->route('page-about')->withsuccess($message);
    }
