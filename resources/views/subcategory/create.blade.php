                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            @if($auth_user->can('category list'))
                                <a href="{{ route('subcategory.index') }}?type={{ $type }}" class="float-right btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::select('category_id', [optional($subcategory->category)->id => optional($subcategory->category)->name], optional($subcategory->category)->id, [
                                            ...
                                            'data-ajax--url' => route('ajax-list', ['type' => 'category','ser_type' => $type ]),
                                        ]) }}
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="sub_image" class="custom-file-input" >
...
?>
                                @if($subcategory->sub_image !=null or $subcategory->sub_image !='')
                                    <div class="col-md-2 mb-2">
                                        @php
                                        //echo $subcategory;
                                          $rr=str_replace('public','',$subcategory->sub_image);
                                        @endphp
                                        <img id="subcategory_image_preview" src="{{$rr}}" alt="#" class="attachment-image mt-1" style="width:100px;height:100px">
