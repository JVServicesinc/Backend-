                        ...
                        {{ Form::model($providerdata,['method' => 'POST','route'=>'provider.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'provider'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 ">
                                        ...
                                        {{ Form::label('lat','Latitude', ['class' => 'form-control-label']) }}
                    {{ Form::text('lat',null, [ 'min' => 0, 'step' => 'any' , 'placeholder' => 'Latitude','class' =>'form-control lat']) }}
                                        </div>
                                        <div class="form-group col-md-6">
                                {{ Form::label('lang','Longitude', ['class' => 'form-control-label']) }}
                        {{ Form::text('lang',null, [ 'min' => 0, 'step' => 'any' , 'placeholder' => 'Longitude','class' =>'form-control lang']) }}
                                        </div>
                                        </div>
                                        <div id="map"></div>
                                    </div>
