    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <form method="POST" action="<?php echo e(route('service.category.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
...
<?php endif; ?><?php /**PATH G:\Jvservices\resources\views/service-category/create.blade.php ENDPATH**/ ?>