                ...
                */
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse" id="jvServices">
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(route('service.category.list')); ?>">
                                <i class="ri-list-unordered"></i>
                                <span>Categoires</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(route('service.subcategory.list')); ?>">
                                <i class="ri-list-unordered"></i>
                                <span>Subcategories</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(route('services.list')); ?>">
                                <i class="ri-list-unordered"></i>
                                <span>Services</span>
                            </a>
                        </li>
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse  " id="document">
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(route('product.category.list')); ?>">
                                <i class="ri-list-unordered"></i>
                                <span>Stores Category</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(route('product.list')); ?>">
                                <i class="ri-add-box-line"></i>
                                <span>Products</span>
                            </a>
                        </li>
                ...
                <li>
                    <a class="nav-link" href="<?php echo e(url('/')); ?>/payment">
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse " id="provider">
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/provider">
                                <i class="ri-list-unordered"></i>
                                <span>Provider List</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/provider/list/pending">
                                <i class="ri-list-unordered"></i>
                                <span>Pending Provider</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/providerpayout">
                                <i class="fas fa-exchange-alt"></i>
                                <span>Payout History</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/providertype">
                                <i class="ri-file-list-3-line"></i>
                                <span>Provider Type List</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/provideraddress">
                                <i class="ri-file-list-3-line"></i>
                                <span>Address List</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/providerdocument">
                                <i class="ri-file-list-3-line"></i>
                                <span>Provider Document List</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/wallet">
                                <i class="fas fa-exchange-alt"></i>
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse  " id="document">
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/document">
                                <i class="ri-list-unordered"></i>
                                <span>Document List</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/document/create">
                                <i class="ri-add-box-line"></i>
                ...
                <li>
                    <a class="nav-link" href="<?php echo e(url('/')); ?>/earning">
                        <i class="fas fa-money-bill-alt"></i>
                        <span>Earning</span>
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="<?php echo e(url('/')); ?>/plans">
                        <i class="ri-list-unordered"></i>
                        <span>Plans</span>
                    </a>
                </li>
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse  " id="slider">
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/slider">
                                <i class="ri-list-unordered"></i>
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse  " id="pages">
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/pages/term-condition">
                                <i class="fas fa-file-contract"></i>
                                <span>Terms Condition</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/pages/privacy-policy">
                                <i class="ri-file-shield-2-line"></i>
                                <span>Privacy Policy</span>
                            </a>
                        </li>
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/pages/about">
                                <i class="ri-file-shield-2-line"></i>
                                <span>About</span>
                            </a>
                        </li>
                ...
                <li class="">
                    ...
                    <ul class="submenu collapse  " id="account_setting">
                        ...
                        <li class="sidebar-layout">
                            <a class="nav-link" href="<?php echo e(url('/')); ?>/permission">
                                <i class="ri-add-box-line"></i>
...
</div><?php /**PATH G:\Jvservices\resources\views/partials/_body_sidebar.blade.php ENDPATH**/ ?>