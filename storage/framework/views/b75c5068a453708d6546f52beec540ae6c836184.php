          ...
          <div class="col-md-5">
             <div class="card p-3">
                <div class="card-body">
                  ...
                  <!--  <h3 class="mb-3 font-weight-bold text-center"><?php echo e(__('auth.sign_in')); ?> AWS</h3>
                      ...
                      <div class="row">
                         <div class="col-lg-12">
                            <div class="form-group">
                               <label class="text-secondary"><?php echo e(__('auth.email')); ?></label>
                         ...
                         <div class="col-lg-12 mt-2">
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center">
                                    <label class="text-secondary"><?php echo e(__('auth.login_password')); ?></label>
...
<?php endif; ?>
<?php /**PATH G:\Jvservices\resources\views/auth/login.blade.php ENDPATH**/ ?>