    ...
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <div class="d-flex align-items-center">
                ...
                <?php if( auth()->user()->hasRole('admin') && URL::current() == route('home') || auth()->user()->hasRole('demo_admin') && URL::current() == route('home')): ?>
                ...
                <?php endif; ?>
                <?php if( auth()->user()->hasRole('provider') && URL::current() == route('home')): ?>
                ...
                <?php endif; ?>
                <?php if( auth()->user()->hasRole('handyman') && URL::current() == route('home')): ?>
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle" id="languageDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                ?>
                                <img src="<?php echo e($selected_lang_flag); ?>" class="img-fluid rounded-circle" alt="lang" style="height: 30px; min-width: 30px; width: 30px;">
                                <span class="bg-primary"></span>
                            </a>
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                <img src="<?php echo e(getSingleMedia(auth()->user(),'profile_image')); ?>" class="img-fluid avatar-rounded" alt="user">
                                <span class="mb-0 ml-2 user-name"><?php echo e(auth()->user()->username); ?></span>
                            </a>
...
<?php /**PATH G:\Jvservices\resources\views/partials/_body_header.blade.php ENDPATH**/ ?>